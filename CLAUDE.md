...
- 2.2.2 — Pedido de reseña + analítica de activación (Fase 1) *(en preparación)*
...
**Pendiente:** probar en device real (iPhone 15 Pro+ con iOS 27 — el modelo no corre en el simulador), tuning del prompt con hojas manuscritas reales, CI a Xcode 27.
